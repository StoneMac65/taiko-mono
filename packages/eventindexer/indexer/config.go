...
type Config struct {
	...
	EpochRevenueStartingBlock *uint64 // Optional starting block number for epoch revenue tracking (nil means use network defaults)
...
func NewConfigFromCliContext(c *cli.Context) (*Config, error) {
	return &Config{
		...
		EpochRevenueStartingBlock: getOptionalUint64(c, flags.EpochRevenueStartingBlock.Name),
		OpenDBFunc: func() (db.DB, error) {
